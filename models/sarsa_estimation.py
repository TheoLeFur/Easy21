...
class SarsaAgent(BaseModel):
    ...
    def train(self):
        ...
        for _ in tqdm(range(int(self.num_episodes))):
            ...
            while not state.terminal:
                ...
                Q_new = self.Q[next_state.dealer - 1, next_state.player -
                               1, Action.to_int(new_action)] * (1 - next_state.terminal)
                alpha = 1./self.N[next_state.dealer - 1,
                                  next_state.player - 1, Action.to_int(new_action)]
